...
export async function GET(request: Request, { params }: { params: { id: string } }) {
  try {
    ...
    if (!authHeader) {
      console.error('Authorization header missing in request to /api/plantings/[id]/tasks');
    ...
    const url = `${apiBaseUrl}/api/plantings/${params.id}/tasks`;
    ...
    console.error('Error in /api/plantings/[id]/tasks:', error);
